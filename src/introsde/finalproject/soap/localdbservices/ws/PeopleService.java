 ...
 * 
 */
@WebServiceClient(name = "PeopleService", targetNamespace = "http://ws.localdbservices.soap.finalproject.introsde/", wsdlLocation = "https://nameless-reaches-22539.herokuapp.com/ws/people?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PEOPLESERVICE_QNAME = new QName("http://ws.localdbservices.soap.finalproject.introsde/", "PeopleService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://nameless-reaches-22539.herokuapp.com/ws/people?wsdl");
    ...
    public People getPeopleImplPort() {
        return super.getPort(new QName("http://ws.localdbservices.soap.finalproject.introsde/", "PeopleImplPort"), People.class);
    }
    ...
    public People getPeopleImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.localdbservices.soap.finalproject.introsde/", "PeopleImplPort"), People.class, features);
    }
